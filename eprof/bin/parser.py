...
parser = argparse.ArgumentParser("Executable to convert outputs eprof libraries into a kvhf file.")

parser.add_argument('-V','--version', action='version', version=version)

parser.add_argument('paths', metavar='PATHS',nargs='+',help="The paths to eprof dirs. Will merge the resulted kvhf into one.")
